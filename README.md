...
- `gorder` reports order parameters per atom in the order in which they appear in the provided .itp file. This is not necessarily the same order as in the acyl chain.
